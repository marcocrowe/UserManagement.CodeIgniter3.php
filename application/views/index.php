...
<body style="margin:auto; width: 900px;">
	<header>
		...
		<div style="float: right;"><a href="<?= site_url("adminlogin/"); ?>"><img width="100px" height="40px" src="<?= base_url() ;?>src/images/transparentpixel.png" alt="Admin Login" /></a></div>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= site_url('shoppingcart/'); ?>">Cart</a>
						</li>
						<?php if (isset($loggedIn) && $loggedIn) {  ?>
							<li class="nav-item">
