<main>
	...
	<div>
		<a href="<?php echo site_url("useraccounts/edit/" . $userAccount->Id); ?>">Edit</a>
		<a href="<?php echo site_url("useraccounts/password/" . $userAccount->Id); ?>">Set Password</a>
		<a href="<?php echo site_url("useraccounts/delete/" . $userAccount->Id); ?>">Delete</a>
		<div>
			<table class="table">
